<%@ Page Title="Admin" Language="C#" MasterPageFile="~/Admin/AdminsMasterPage.master" AutoEventWireup="true" CodeBehind="Admin.aspx.cs" Inherits="FoodHouse.Admin.Admin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <div  style="width:25%;  margin:40px auto; display: flex;
    flex-direction: column;   box-shadow: 0 4px 8px 0 rgba(0,0,0,0.2); padding:10px;">
          
            <div  style="margin-top: 10px;margin-left: auto;width: 165px;margin-right: auto;"> 
...
<g>
            ...
            <div  class="entry">
              <asp:Label ID="Label1" Text="Admin Name " runat="server" />
                <%--<asp:TextBox runat="server" ID="txtAdminName" Width="100%" Height="30" />--%>
                <asp:TextBox runat="server"  ID="txtAdminName" Width="100%" Height="30" />
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Required*"  SetFocusOnError="true" ForeColor="Red" ControlToValidate="txtAdminName" Display="Dynamic">

                </asp:RequiredFieldValidator>
            </div>
            <div class="entry">
                <asp:Label ID="Label2" Text="Password" runat="server" />
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Required*"  SetFocusOnError="true" ForeColor="Red" ControlToValidate="txtPassword" Display="Dynamic"></asp:RequiredFieldValidator>
            ...
            <div class="entry">
                ...
                <asp:RequiredFieldValidator CssClass="val" ID="RequiredFieldValidator3" runat="server" ErrorMessage="Required*"  SetFocusOnError="true" ForeColor="Red" ControlToValidate="txtConfirmPassword" Display="Dynamic"></asp:RequiredFieldValidator>
                <asp:CompareValidator ID="CompareValidator1" runat="server" CssClass="val" ErrorMessage="Password should match" ControlToCompare="txtConfirmPassword"  ControlToValidate="txtPassword" ForeColor="Red" Display="Dynamic"   ></asp:CompareValidator>
                <asp:TextBox runat="server" ID="txtConfirmPassword" TextMode="Password" Width="100%" Height="30" />

            </div>
            <div style="display:flex; justify-content: space-around;">
          
                <asp:Button  Text="Save" Width="80" Height="30" ID="btnSave" runat="server" OnClick="btnSave_Click" />
         
                <%--<asp:Button Text="Cancel" ID="btnCancel" Width="80" Height="30" runat="server" />--%>
               
                <asp:HyperLink ID="HyperLink1" Text="Cancel"  NavigateUrl="~/Admin/AdminList.aspx" runat="server"></asp:HyperLink>
